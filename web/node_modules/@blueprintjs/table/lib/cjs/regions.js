...
var Regions = /** @class */ (function () {
    ...
    Regions.getRegionFromFocusedRegion = function (focusedRegion) {
    ...
    Regions.joinStyledRegionGroups = function (selectedRegions, otherRegions, focusedRegionOrCell) {
        var focusedRegion = focusedRegionOrCell == null
            ? undefined
            : "type" in focusedRegionOrCell
                ? focusedRegionOrCell
                : tslib_1.__assign(tslib_1.__assign({}, focusedRegionOrCell), { type: cellTypes_1.FocusMode.CELL });
        var regionGroups = [];
