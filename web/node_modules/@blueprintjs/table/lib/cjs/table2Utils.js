...
function getHotkeysFromProps(props, hotkeysImpl) {
    var getCellClipboardData = props.getCellClipboardData, enableMultipleSelection = props.enableMultipleSelection, selectionModes = props.selectionModes;
    var focusMode = (0, focusedCellUtils_1.getFocusModeFromProps)(props);
    var hotkeys = [];
    ...
    hotkeys.push.apply(hotkeys, getFocusHotkeys(focusMode, hotkeysImpl));
