...
var LocatorImpl = /** @class */ (function () {
    ...
    // Setters
    // =======
    LocatorImpl.prototype.setGrid = function (grid) {
        this.grid = grid;
        return this;
    };
    LocatorImpl.prototype.setNumFrozenRows = function (numFrozenRows) {
        this.numFrozenRows = numFrozenRows;
        return this;
    };
    LocatorImpl.prototype.setNumFrozenColumns = function (numFrozenColumns) {
        this.numFrozenColumns = numFrozenColumns;
        return this;
    };
    // Getters
    // =======
    LocatorImpl.prototype.getViewportRect = function () {
    ...
    LocatorImpl.prototype.getWidestVisibleCellInColumn = function (columnIndex) {
        ...
        for (var i = 0; i < columnHeaderAndBodyCells.length; i++) {
            ...
            var cellWidth = Math.ceil(contentWidth) + LocatorImpl.CELL_HORIZONTAL_PADDING * 2;
    ...
    LocatorImpl.prototype.getTallestVisibleCellInColumn = function (columnIndex) {
     ...
     */
    LocatorImpl.prototype.hasVerticalOverflowOrExactFit = function (columnHeaderHeight, viewportRect) {
        if (columnHeaderHeight === void 0) { columnHeaderHeight = grid_1.Grid.MIN_COLUMN_HEADER_HEIGHT; }
     ...
     */
    LocatorImpl.prototype.hasHorizontalOverflowOrExactFit = function (rowHeaderWidth, viewportRect) {
        if (rowHeaderWidth === void 0) { rowHeaderWidth = grid_1.Grid.MIN_ROW_HEADER_WIDTH; }
        if (viewportRect === void 0) { viewportRect = this.getViewportRect(); }
        if (this.grid === undefined) {
            return false;
        }
    ...
    // Converters
    // ==========
    LocatorImpl.prototype.convertPointToColumn = function (clientX, useMidpoint) {
    ...
    LocatorImpl.prototype.convertPointToRow = function (clientY, useMidpoint) {
        var tableRect = this.getTableRect();
    ...
    LocatorImpl.prototype.convertPointToCell = function (clientX, clientY) {
        var gridX = this.toGridX(clientX);
        var gridY = this.toGridY(clientY);
    ...
    // Private helpers
    // ===============
    LocatorImpl.prototype.getColumnCellSelector = function (columnIndex) {
    ...
    LocatorImpl.prototype.getTableRect = function () {
        return rect_1.Rect.wrap(this.tableElement.getBoundingClientRect());
    };
    LocatorImpl.CELL_HORIZONTAL_PADDING = 10;
    return LocatorImpl;
}());
