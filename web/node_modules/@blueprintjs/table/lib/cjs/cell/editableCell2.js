...
var EditableCell2 = /** @class */ (function (_super) {
    ...
    function EditableCell2() {
        ...
        _this.renderCell = function (_a) {
            ...
            if (isEditing) {
                ...
                cellContents = (React.createElement(core_1.EditableText, tslib_1.__assign({}, editableTextProps, { isEditing: true, className: (0, classnames_1.default)(Classes.TABLE_EDITABLE_TEXT, Classes.TABLE_EDITABLE_NAME, className), elementRef: _this.contentsRef, intent: spreadableProps.intent, minWidth: 0, onCancel: _this.handleCancel, onChange: _this.handleChange, onConfirm: _this.handleConfirm, onEdit: _this.handleEdit, placeholder: "", selectAllOnFocus: false, value: dirtyValue })));
            }
            else {
            ...
            return (React.createElement(cell_1.Cell, tslib_1.__assign({}, spreadableProps, { wrapText: wrapText, truncated: false, interactive: interactive, cellRef: _this.cellRef, onKeyDown: handleKeyDown, onKeyPress: _this.handleKeyPress, onKeyUp: handleKeyUp, tabIndex: tabIndex }),
                React.createElement(draggable_1.Draggable, { onActivate: _this.handleCellActivate, onDoubleClick: _this.handleCellDoubleClick, preventDefault: false, stopPropagation: interactive, targetRef: _this.contentsRef }, cellContents)));
        };
        _this.handleKeyPress = function () {
            ...
            _this.setState({ dirtyValue: "", isEditing: true, savedValue: _this.state.savedValue });
        };
        _this.handleEdit = function () {
            _this.setState({ dirtyValue: _this.state.savedValue, isEditing: true });
        };
        _this.handleCancel = function (value) {
            // don't strictly need to clear the dirtyValue, but it's better hygiene
            _this.setState({ dirtyValue: undefined, isEditing: false });
        ...
        _this.handleConfirm = function (value) {
            _this.setState({ dirtyValue: undefined, isEditing: false, savedValue: value });
    ...
    EditableCell2.prototype.checkShouldFocus = function () {
        ...
        if (this.props.isFocused && !this.state.isEditing) {
            ...
            (_a = this.cellRef.current) === null || _a === void 0 ? void 0 : _a.focus();
        }
    };
