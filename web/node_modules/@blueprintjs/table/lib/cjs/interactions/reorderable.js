...
var DragReorderable = /** @class */ (function (_super) {
    ...
    DragReorderable.prototype.getDraggableHandlers = function () {
    ...
    DragReorderable.prototype.maybeSelectRegion = function (region) {
        ...
        if (!core_1.Utils.deepCompareKeys(nextSelectedRegions, this.props.selectedRegions)) {
            ...
            var focusedCellCoords = regions_1.Regions.getFocusCellCoordinatesFromRegion(region);
            var newFocusedRegion = (0, focusedCellUtils_1.toFocusedRegion)(this.props.focusMode, focusedCellCoords);
