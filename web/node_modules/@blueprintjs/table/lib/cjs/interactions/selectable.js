...
var DefaultFocusedCellUtils = tslib_1.__importStar(require("../common/internal/focusedCellUtils"));
...
var DragSelectable = /** @class */ (function (_super) {
    ...
    function DragSelectable() {
        ...
        _this.handleDragMove = function (event, coords) {
            var _a = _this.props, enableMultipleSelection = _a.enableMultipleSelection, locateClick = _a.locateClick, locateDrag = _a.locateDrag, selectedRegions = _a.selectedRegions, selectedRegionTransform = _a.selectedRegionTransform;
            ...
            var nextSelectedRegions = _this.didExpandSelectionOnActivate
                ? _this.expandSelectedRegions(selectedRegions, region, _this.getFocusedRegion())
        ...
        _this.handleExpandSelection = function (region) {
            ...
            var nextSelectedRegions = _this.expandSelectedRegions(selectedRegions, region, _this.getFocusedRegion());
            _this.maybeInvokeSelectionCallback(nextSelectedRegions);
        ...
        _this.invokeOnFocusCallbackForRegion = function (focusRegion, focusSelectionIndex) {
            ...
            var _a = _this.props, focusMode = _a.focusMode, onFocusedCell = _a.onFocusedCell, onFocusedRegion = _a.onFocusedRegion;
            var focusedCellCoords = regions_1.Regions.getFocusCellCoordinatesFromRegion(focusRegion);
            var newFocusedRegion = _this.focusedCellUtils.toFocusedRegion(focusMode, focusedCellCoords, focusSelectionIndex);
            if (newFocusedRegion != null) {
                onFocusedRegion === null || onFocusedRegion === void 0 ? void 0 : onFocusedRegion(newFocusedRegion);
            }
            // Keep this call for backward compatibility
            onFocusedCell === null || onFocusedCell === void 0 ? void 0 : onFocusedCell(_this.focusedCellUtils.toFocusedRegion(cellTypes_1.FocusMode.CELL, focusedCellCoords, focusSelectionIndex));
        };
        // Other
        // =====
    ...
    Object.defineProperty(DragSelectable.prototype, "focusedCellUtils", {
        get: function () {
            return tslib_1.__assign(tslib_1.__assign({}, DefaultFocusedCellUtils), this.props.focusedCellUtils);
        },
        enumerable: false,
        configurable: true
    });
    DragSelectable.prototype.render = function () {
        var draggableProps = this.getDraggableHandlers();
        return (React.createElement(draggable_1.Draggable, tslib_1.__assign({}, draggableProps, { preventDefault: false, targetRef: this.props.targetRef }), this.props.children));
    };
    DragSelectable.prototype.getDraggableHandlers = function () {
     ...
     */
    DragSelectable.prototype.expandSelectedRegions = function (regions, region, focusedRegion) {
        if (regions.length === 0) {
            return [region];
        }
        else if (focusedRegion != null) {
            var expandedRegion = this.focusedCellUtils.expandFocusedRegion(focusedRegion, region);
    ...
    DragSelectable.prototype.getFocusedRegion = function () {
        // eslint-disable-next-line @typescript-eslint/no-deprecated
        var _a = this.props, focusedCell = _a.focusedCell, focusedRegion = _a.focusedRegion;
        if (focusedRegion != null) {
            return focusedRegion;
        }
        if (focusedCell != null) {
            return tslib_1.__assign(tslib_1.__assign({}, focusedCell), { type: cellTypes_1.FocusMode.CELL });
        }
        return undefined;
    };
    ...
    DragSelectable.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".DragSelectable");
