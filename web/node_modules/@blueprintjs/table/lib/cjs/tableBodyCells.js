...
var TableBodyCells = /** @class */ (function (_super) {
    ...
    function TableBodyCells() {
        ...
        _this.renderCell = function (rowIndex, columnIndex, extremaClasses, isGhost) {
            var _a;
            var _b = _this.props, cellRenderer = _b.cellRenderer, loading = _b.loading, grid = _b.grid;
            ...
            var isFocused = _this.isCellFocused(rowIndex, columnIndex);
    ...
    TableBodyCells.prototype.isCellFocused = function (rowIndex, columnIndex) {
        var focusedRegion = this.props.focusedRegion;
        switch (focusedRegion === null || focusedRegion === void 0 ? void 0 : focusedRegion.type) {
