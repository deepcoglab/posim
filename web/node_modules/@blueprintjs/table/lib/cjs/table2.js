...
var scrollDirection_1 = require("./common/scrollDirection");
...
var Table2 = /** @class */ (function (_super) {
    ...
    function Table2(props) {
        ...
        _this.selectAll = function (shouldUpdateFocusedCell) {
            ...
            if (shouldUpdateFocusedCell) {
                ...
                if (newFocusedRegion != null) {
                    _this.handleFocus(newFocusedRegion);
                }
            }
        };
        ...
        _this.renderColumnHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenColumnsOnly) {
            ...
            var _b = _this.state, focusedRegion = _b.focusedRegion, selectedRegions = _b.selectedRegions, viewportRect = _b.viewportRect;
            ...
            var hasHorizontalOverflowOrExactFit = _this.locator.hasHorizontalOverflowOrExactFit(_this.getRowHeaderWidth(), viewportRect);
        ...
        _this.renderRowHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenRowsOnly) {
            ...
            // (this avoids problems like https://github.com/palantir/blueprint/issues/5027)
            var hasVerticalOverflowOrExactFit = _this.locator.hasVerticalOverflowOrExactFit(_this.getColumnHeaderHeight(), viewportRect);
            ...
            return (React.createElement("div", { className: classes, ref: refHandler },
                React.createElement(rowHeader_1.RowHeader, { defaultRowHeight: defaultRowHeight, enableMultipleSelection: enableMultipleSelection, focusedRegion: focusedRegion, focusMode: FocusedCellUtils.getFocusModeFromProps(_this.props), grid: _this.grid, locator: _this.locator, isReorderable: enableRowReordering, isResizable: enableRowResizing, loading: (0, tableUtils_1.hasLoadingOption)(loadingOptions, regions_2.TableLoadingOption.ROW_HEADERS), maxRowHeight: maxRowHeight, minRowHeight: minRowHeight, onFocusedRegion: _this.handleFocus, onLayoutLock: _this.handleLayoutLock, onMount: _this.handleHeaderMounted, onResizeGuide: resizeHandler, onReordered: _this.handleRowsReordered, onReordering: reorderingHandler, onRowHeightChanged: _this.handleRowHeightChanged, onSelection: _this.getEnabledSelectionHandler(regions_2.RegionCardinality.FULL_ROWS), rowHeaderCellRenderer: rowHeaderCellRenderer, selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd }),
        ...
        _this.renderBody = function (quadrantType, showFrozenRowsOnly, showFrozenColumnsOnly) {
            if (showFrozenRowsOnly === void 0) { showFrozenRowsOnly = false; }
            if (showFrozenColumnsOnly === void 0) { showFrozenColumnsOnly = false; }
            var _a = _this.state, focusedRegion = _a.focusedRegion, numFrozenColumns = _a.numFrozenColumnsClamped, numFrozenRows = _a.numFrozenRowsClamped, selectedRegions = _a.selectedRegions, viewportRect = _a.viewportRect;
            var _b = _this.props, enableMultipleSelection = _b.enableMultipleSelection, enableColumnHeader = _b.enableColumnHeader, enableGhostCells = _b.enableGhostCells, loadingOptions = _b.loadingOptions, bodyContextMenuRenderer = _b.bodyContextMenuRenderer, selectedRegionTransform = _b.selectedRegionTransform;
            if (_this.grid === null || _this.locator === undefined || viewportRect === undefined) {
                return undefined;
            }
            ...
            return (React.createElement("div", null,
                React.createElement(tableBody2_1.TableBody2, { enableMultipleSelection: enableMultipleSelection, cellRenderer: _this.bodyCellRenderer, focusedRegion: focusedRegion, focusMode: FocusedCellUtils.getFocusModeFromProps(_this.props), grid: _this.grid, loading: (0, tableUtils_1.hasLoadingOption)(loadingOptions, regions_2.TableLoadingOption.CELLS), locator: _this.locator, onCompleteRender: onCompleteRender, onFocusedRegion: _this.handleFocus, onSelection: _this.getEnabledSelectionHandler(regions_2.RegionCardinality.CELLS), bodyContextMenuRenderer: bodyContextMenuRenderer, renderMode: _this.getNormalizedRenderMode(), selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, viewportRect: viewportRect, columnIndexStart: columnIndexStart, columnIndexEnd: columnIndexEnd, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd, numFrozenColumns: showFrozenColumnsOnly ? numFrozenColumns : undefined, numFrozenRows: showFrozenRowsOnly ? numFrozenRows : undefined }),
        ...
        _this.renderScrollIndicatorOverlay = function (scrollBarWidth, columnHeaderHeight) {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement("div", { className: (0, classnames_1.default)(baseClass, Classes.TABLE_BODY_IS_SCROLLING_TOP), style: getStyle(scrollDirection, scrollDirection_1.ScrollDirection.TOP) }),
                React.createElement("div", { className: (0, classnames_1.default)(baseClass, Classes.TABLE_BODY_IS_SCROLLING_BOTTOM), style: getStyle(scrollDirection, scrollDirection_1.ScrollDirection.BOTTOM) }),
                React.createElement("div", { className: (0, classnames_1.default)(baseClass, Classes.TABLE_BODY_IS_SCROLLING_RIGHT), style: getStyle(scrollDirection, scrollDirection_1.ScrollDirection.RIGHT) }),
                React.createElement("div", { className: (0, classnames_1.default)(baseClass, Classes.TABLE_BODY_IS_SCROLLING_LEFT), style: getStyle(scrollDirection, scrollDirection_1.ScrollDirection.LEFT) })));
        };
        ...
        _this.syncViewportPosition = function (_a) {
            ...
            var viewportRect = _this.state.viewportRect;
            if (_this.scrollContainerElement == null || viewportRect === undefined) {
                return;
            }
            if (nextScrollLeft !== undefined || nextScrollTop !== undefined) {
                if (nextScrollTop !== undefined) {
                    _this.scrollContainerElement.scrollTop = nextScrollTop;
                }
                if (nextScrollLeft !== undefined) {
                    _this.scrollContainerElement.scrollLeft = nextScrollLeft;
                }
                var nextViewportRect = new rect_1.Rect(nextScrollLeft !== null && nextScrollLeft !== void 0 ? nextScrollLeft : viewportRect.left, nextScrollTop !== null && nextScrollTop !== void 0 ? nextScrollTop : viewportRect.top, viewportRect.width, viewportRect.height);
                _this.updateViewportRect(nextViewportRect);
            }
        };
        _this.handleFocus = function (focusedRegion) {
            var _a, _b, _c, _d;
            if (FocusedCellUtils.getFocusModeFromProps(_this.props) !== (focusedRegion === null || focusedRegion === void 0 ? void 0 : focusedRegion.type)) {
                // don't set focus state if given focus mode is not enabled
                return;
            }
            // only set focused region state if not specified in props
            if (FocusedCellUtils.getFocusedRegionFromProps(_this.props) == null) {
                _this.setState({ focusedRegion: focusedRegion });
            }
            if (focusedRegion == null) {
                return;
            }
            if (focusedRegion.type === cellTypes_1.FocusMode.CELL) {
                var type = focusedRegion.type, focusedCell = tslib_1.__rest(focusedRegion, ["type"]);
                // eslint-disable-next-line @typescript-eslint/no-deprecated
                (_b = (_a = _this.props).onFocusedCell) === null || _b === void 0 ? void 0 : _b.call(_a, focusedCell);
            }
            (_d = (_c = _this.props).onFocusedRegion) === null || _d === void 0 ? void 0 : _d.call(_c, focusedRegion);
        };
        ...
        _this.handleRowsReordering = function (horizontalGuides) {
            _this.setState({ horizontalGuides: horizontalGuides, isReordering: true });
        };
        _this.handleRowsReordered = function (oldIndex, newIndex, length) {
            var _a, _b;
            _this.setState({ horizontalGuides: [], isReordering: false });
        ...
        _this.getHeaderDimensions = function () {
            return {
                columnHeaderHeight: _this.getColumnHeaderHeight(),
                rowHeaderWidth: _this.getRowHeaderWidth(),
            };
        };
        _this.getColumnHeaderHeight = function () {
            return _this.props.enableColumnHeader ? _this.columnHeaderHeight : 0;
        };
        _this.getRowHeaderWidth = function () {
            return _this.props.enableRowHeader ? _this.rowHeaderWidth : 0;
        };
        ...
        var focusedRegion = FocusedCellUtils.getInitialFocusedRegion(FocusedCellUtils.getFocusModeFromProps(props), FocusedCellUtils.getFocusedRegionFromProps(props), undefined, selectedRegions);
        _this.state = {
        ...
        _this.hotkeysImpl = new tableHotkeys_1.TableHotkeys(props, _this.state, {
            ...
            getHeaderDimensions: _this.getHeaderDimensions,
    ...
    Table2.getDerivedStateFromProps = function (props, state) {
        var children = props.children, defaultColumnWidth = props.defaultColumnWidth, defaultRowHeight = props.defaultRowHeight, numRows = props.numRows, selectedRegions = props.selectedRegions, selectionModes = props.selectionModes;
        ...
        var newFocusedRegion = FocusedCellUtils.getInitialFocusedRegion(FocusedCellUtils.getFocusModeFromProps(props), FocusedCellUtils.getFocusedRegionFromProps(props), state.focusedRegion, newSelectedRegions);
        var nextState = {
    ...
    Table2.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        var newFocusMode = FocusedCellUtils.getFocusModeFromProps(this.props);
        var didFocusModeChange = newFocusMode !== FocusedCellUtils.getFocusModeFromProps(prevProps);
        var shouldInvalidateHotkeys = didFocusModeChange ||
    ...
    Table2.prototype.maybeRenderRegions = function (getRegionStyle, quadrantType) {
        ...
        var regionGroups = regions_2.Regions.joinStyledRegionGroups(this.state.selectedRegions, (_a = this.props.styledRegionGroups) !== null && _a !== void 0 ? _a : [], this.state.focusedRegion);
