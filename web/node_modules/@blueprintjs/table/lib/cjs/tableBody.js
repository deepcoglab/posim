...
var focusedCellUtils_1 = require("./common/internal/focusedCellUtils");
...
var TableBody = /** @class */ (function (_super) {
    ...
    function TableBody() {
        ...
        _this.renderContextMenu = function (e) {
            var _a = _this.props, bodyContextMenuRenderer = _a.bodyContextMenuRenderer, focusMode = _a.focusMode, grid = _a.grid, onFocusedRegion = _a.onFocusedRegion, onSelection = _a.onSelection, _b = _a.selectedRegions, selectedRegions = _b === void 0 ? [] : _b;
            ...
            if (foundIndex < 0) {
                ...
                var focusedCellCoords = regions_1.Regions.getFocusCellCoordinatesFromRegion(targetRegion);
                var newFocusedRegion = (0, focusedCellUtils_1.toFocusedRegion)(focusMode, focusedCellCoords);
                if (newFocusedRegion != null) {
                    onFocusedRegion(newFocusedRegion);
                }
            }
            var menuContext = new menus_1.MenuContextImpl(targetRegion, nextSelectedRegions, numRows, numCols);
    ...
    TableBody.prototype.render = function () {
        ...
        return (React.createElement(selectable_1.DragSelectable, { enableMultipleSelection: this.props.enableMultipleSelection, focusedRegion: this.props.focusedRegion, focusMode: this.props.focusMode, locateClick: this.locateClick, locateDrag: this.locateDrag, onFocusedRegion: this.props.onFocusedRegion, onSelection: this.props.onSelection, onSelectionEnd: this.handleSelectionEnd, selectedRegions: this.props.selectedRegions, selectedRegionTransform: this.props.selectedRegionTransform, targetRef: this.wrapperRef },
            React.createElement(contextMenuTargetWrapper_1.ContextMenuTargetWrapper, { className: (0, classnames_1.default)(Classes.TABLE_BODY_VIRTUAL_CLIENT, Classes.TABLE_CELL_CLIENT), renderContextMenu: this.renderContextMenu, style: style, targetRef: this.wrapperRef },
                React.createElement(tableBodyCells_1.TableBodyCells, { cellRenderer: this.props.cellRenderer, focusedRegion: this.props.focusedRegion, grid: grid, loading: this.props.loading, onCompleteRender: this.props.onCompleteRender, renderMode: this.props.renderMode, columnIndexStart: this.props.columnIndexStart, columnIndexEnd: this.props.columnIndexEnd, rowIndexStart: this.props.rowIndexStart, rowIndexEnd: this.props.rowIndexEnd, viewportRect: this.props.viewportRect }))));
    };
