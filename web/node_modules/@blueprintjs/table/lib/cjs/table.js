...
exports.getInitialFocusedCell = exports.Table = void 0;
...
var Table = /** @class */ (function (_super) {
    ...
    function Table(props) {
        ...
        _this.selectAll = function (shouldUpdateFocusedCell) {
            ...
            if (shouldUpdateFocusedCell) {
                var focusMode = _this.getFocusMode();
        ...
        _this.renderColumnHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenColumnsOnly) {
            ...
            return (React.createElement("div", { className: classes },
                React.createElement(columnHeader_1.ColumnHeader, { defaultColumnWidth: defaultColumnWidth, enableMultipleSelection: enableMultipleSelection, cellRenderer: _this.columnHeaderCellRenderer, focusedRegion: focusedRegion, focusMode: _this.getFocusMode(), grid: _this.grid, isReorderable: enableColumnReordering, isResizable: enableColumnResizing, loading: (0, tableUtils_1.hasLoadingOption)(loadingOptions, regions_2.TableLoadingOption.COLUMN_HEADERS), locator: _this.locator, maxColumnWidth: maxColumnWidth, measurableElementRef: refHandler, minColumnWidth: minColumnWidth, onColumnWidthChanged: _this.handleColumnWidthChanged, onFocusedRegion: _this.handleFocus, onLayoutLock: _this.handleLayoutLock, onReordered: _this.handleColumnsReordered, onReordering: reorderingHandler, onResizeGuide: resizeHandler, onSelection: _this.getEnabledSelectionHandler(regions_2.RegionCardinality.FULL_COLUMNS), selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, columnIndexStart: columnIndexStart, columnIndexEnd: columnIndexEnd }, _this.props.children),
        ...
        _this.renderRowHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenRowsOnly) {
            ...
            var classes = (0, classnames_1.default)(Classes.TABLE_ROW_HEADERS, (_a = {},
                ...
                _a));
            var rowIndices = _this.grid.getRowIndicesInRect({ includeGhostCells: enableGhostCells, rect: viewportRect });
            ...
            return (React.createElement("div", { className: classes, ref: refHandler },
                React.createElement(rowHeader_1.RowHeader, { defaultRowHeight: defaultRowHeight, enableMultipleSelection: enableMultipleSelection, focusedRegion: focusedRegion, focusMode: _this.getFocusMode(), grid: _this.grid, locator: _this.locator, isReorderable: enableRowReordering, isResizable: enableRowResizing, loading: (0, tableUtils_1.hasLoadingOption)(loadingOptions, regions_2.TableLoadingOption.ROW_HEADERS), maxRowHeight: maxRowHeight, minRowHeight: minRowHeight, onFocusedRegion: _this.handleFocus, onLayoutLock: _this.handleLayoutLock, onResizeGuide: resizeHandler, onReordered: _this.handleRowsReordered, onReordering: reorderingHandler, onRowHeightChanged: _this.handleRowHeightChanged, onSelection: _this.getEnabledSelectionHandler(regions_2.RegionCardinality.FULL_ROWS), rowHeaderCellRenderer: rowHeaderCellRenderer, selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd }),
        ...
        _this.renderBody = function (quadrantType, showFrozenRowsOnly, showFrozenColumnsOnly) {
            ...
            return (React.createElement("div", null,
                React.createElement(tableBody_1.TableBody, { enableMultipleSelection: enableMultipleSelection, cellRenderer: _this.bodyCellRenderer, focusedRegion: focusedRegion, focusMode: _this.getFocusMode(), grid: _this.grid, loading: (0, tableUtils_1.hasLoadingOption)(loadingOptions, regions_2.TableLoadingOption.CELLS), locator: _this.locator, onCompleteRender: onCompleteRender, onFocusedRegion: _this.handleFocus, onSelection: _this.getEnabledSelectionHandler(regions_2.RegionCardinality.CELLS), bodyContextMenuRenderer: bodyContextMenuRenderer, renderMode: _this.getNormalizedRenderMode(), selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, viewportRect: viewportRect, columnIndexStart: columnIndexStart, columnIndexEnd: columnIndexEnd, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd, numFrozenColumns: showFrozenColumnsOnly ? numFrozenColumns : undefined, numFrozenRows: showFrozenRowsOnly ? numFrozenRows : undefined }),
        ...
        _this.handleFocus = function (focusedRegion) {
            ...
            var _c = focusedRegion, type = _c.type, focusedCell = tslib_1.__rest(_c, ["type"]);
        ...
        _this.getColumnHeaderHeight = function () {
            var _a, _b;
            return _this.props.enableColumnHeader
                ? (_b = (_a = _this.columnHeaderElement) === null || _a === void 0 ? void 0 : _a.clientHeight) !== null && _b !== void 0 ? _b : grid_1.Grid.MIN_COLUMN_HEADER_HEIGHT
                : 0;
        };
        _this.getRowHeaderWidth = function () {
            var _a, _b;
            return _this.props.enableRowHeader ? (_b = (_a = _this.rowHeaderElement) === null || _a === void 0 ? void 0 : _a.clientWidth) !== null && _b !== void 0 ? _b : grid_1.Grid.MIN_ROW_HEADER_WIDTH : 0;
        };
        ...
        var focusedCell = getInitialFocusedCell(props.enableFocusedCell, props.focusedCell, undefined, selectedRegions);
        _this.state = {
    ...
    Table.getDerivedStateFromProps = function (props, state) {
        ...
        var newFocusedCell = getInitialFocusedCell(enableFocusedCell, focusedCell, state.focusedRegion, newSelectedRegions);
        var nextState = {
    ...
    Table.prototype.render = function () {
        ...
        var classes = (0, classnames_1.default)(Classes.TABLE_CONTAINER, (_a = {},
    ...
    Table.prototype.validateGrid = function () {
        if (this.grid == null) {
            ...
            this.grid = new grid_1.Grid(rowHeights, columnWidths, gridBleed, defaultRowHeight, defaultColumnWidth);
    ...
    Table.prototype.getFocusMode = function () {
        return this.props.enableFocusedCell ? cellTypes_1.FocusMode.CELL : undefined;
    };
    var Table_1;
    Table.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".Table");
    Table.defaultProps = {
        ...
        getCellClipboardData: function (row, col, cellRenderer) {
            return (0, react_innertext_1.default)(cellRenderer === null || cellRenderer === void 0 ? void 0 : cellRenderer(row, col));
        },
        loadingOptions: [],
        maxColumnWidth: 9999,
        maxRowHeight: 9999,
...
function getInitialFocusedCell(enableFocusedCell, focusedCellFromProps, focusedCellFromState, selectedRegions) {
    if (!enableFocusedCell) {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, regions_2.Regions.getFocusCellCoordinatesFromRegion(selectedRegions[lastIndex])), { focusSelectionIndex: lastIndex });
    }
    else {
