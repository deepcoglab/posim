...
var SHALLOW_COMPARE_PROP_KEYS_DENYLIST = ["focusedRegion", "selectedRegions"];
var Header = /** @class */ (function (_super) {
    ...
    function Header(props) {
        ...
        _this.reorderHandleRefs = new Map();
        ...
        _this.renderCell = function (index, extremaClasses) {
            ...
            var cellTargetRef = getOrCreateRef(_this.cellRefs, index);
            var cellProps = (_b = {
                    className: className,
                    index: index
                },
            ...
            var baseChildren = (React.createElement(selectable_1.DragSelectable, { enableMultipleSelection: _this.props.enableMultipleSelection, disabled: _this.isDragSelectableDisabled, focusedRegion: _this.props.focusedRegion, focusMode: _this.props.focusMode, ignoredSelectors: [".".concat(Classes.TABLE_REORDER_HANDLE_TARGET)], key: getIndexClass(index), locateClick: _this.locateClick, locateDrag: _this.locateDragForSelection, onFocusedRegion: _this.props.onFocusedRegion, onSelection: _this.handleDragSelectableSelection, onSelectionEnd: _this.handleDragSelectableSelectionEnd, selectedRegions: selectedRegions, selectedRegionTransform: _this.props.selectedRegionTransform, targetRef: cellTargetRef },
            ...
            return _this.isReorderHandleEnabled()
                ...
                : _this.wrapInDragReorderable(index, baseChildren, _this.isDragReorderableDisabled, cellTargetRef);
        };
    ...
    Header.prototype.maybeRenderReorderHandle = function (index) {
        var handleTargetRef = getOrCreateRef(this.reorderHandleRefs, index);
        return !this.isReorderHandleEnabled()
            ? undefined
            : this.wrapInDragReorderable(index, React.createElement("div", { className: Classes.TABLE_REORDER_HANDLE_TARGET, ref: handleTargetRef },
                React.createElement("div", { className: (0, classnames_1.default)(Classes.TABLE_REORDER_HANDLE, utils_1.CLASSNAME_EXCLUDED_FROM_TEXT_MEASUREMENT) },
                    React.createElement(icons_1.DragHandleVertical, { title: "Press down to drag" }))), false, handleTargetRef);
    };
    Header.prototype.isColumnHeader = function () {
        return this.props.fullRegionCardinality === regions_1.RegionCardinality.FULL_COLUMNS;
    };
    Header.prototype.wrapInDragReorderable = function (index, children, disabled, targetRef) {
        return (React.createElement(reorderable_1.DragReorderable, { disabled: disabled, focusMode: this.props.focusMode, key: this.props.getIndexClass(index), locateClick: this.locateClick, locateDrag: this.locateDragForReordering, onReordered: this.props.onReordered, onReordering: this.props.onReordering, onSelection: this.props.onSelection, onFocusedRegion: this.props.onFocusedRegion, selectedRegions: this.props.selectedRegions, targetRef: targetRef, toRegion: this.props.toRegion }, children));
    };
    return Header;
}(React.Component));
