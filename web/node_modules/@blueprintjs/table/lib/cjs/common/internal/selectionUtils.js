...
function resizeRegion(region, direction, focusedRegion) {
    ...
    if (focusedRegion != null) {
        var isAtTop = FocusedCellUtils.isFocusAtRegionTop(nextRegion, focusedRegion);
        var isAtBottom = FocusedCellUtils.isFocusAtRegionBottom(nextRegion, focusedRegion);
        var isAtLeft = FocusedCellUtils.isFocusAtRegionLeft(nextRegion, focusedRegion);
        var isAtRight = FocusedCellUtils.isFocusAtRegionRight(nextRegion, focusedRegion);
