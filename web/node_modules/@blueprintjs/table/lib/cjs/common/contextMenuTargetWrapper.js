...
var ContextMenuTargetWrapper = /** @class */ (function (_super) {
    ...
    ContextMenuTargetWrapper.prototype.render = function () {
        var _a = this.props, className = _a.className, children = _a.children, targetRef = _a.targetRef, style = _a.style;
        return (React.createElement("div", { className: className, style: style, ref: targetRef }, children));
    };
    ...
    ContextMenuTargetWrapper = tslib_1.__decorate([
        core_1.ContextMenuTargetLegacy
