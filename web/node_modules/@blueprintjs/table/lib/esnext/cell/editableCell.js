...
let EditableCell = class EditableCell extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Cell, { ...spreadableProps, wrapText: wrapText, truncated: false, interactive: interactive, cellRef: this.cellRef, onKeyPress: this.handleKeyPress },
