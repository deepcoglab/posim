...
export class EditableCell2 extends React.Component {
    ...
    renderCell = ({ handleKeyDown, handleKeyUp }) => {
        ...
        return (React.createElement(Cell, { ...spreadableProps, wrapText: wrapText, truncated: false, interactive: interactive, cellRef: this.cellRef, onKeyDown: handleKeyDown, onKeyPress: this.handleKeyPress, onKeyUp: handleKeyUp, tabIndex: tabIndex },
