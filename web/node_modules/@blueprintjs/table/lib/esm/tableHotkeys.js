...
var TableHotkeys = /** @class */ (function () {
    function TableHotkeys(props, state, tableHandlers) {
        ...
        // Focus
        // =====
        this.handleFocusMoveLeft = function (e) { return _this.handleFocusMove(e, Direction.LEFT); };
        this.handleFocusMoveLeftInternal = function (e) { return _this.handleFocusMoveInternal(e, Direction.LEFT); };
        this.handleFocusMoveRight = function (e) { return _this.handleFocusMove(e, Direction.RIGHT); };
        this.handleFocusMoveRightInternal = function (e) { return _this.handleFocusMoveInternal(e, Direction.RIGHT); };
        this.handleFocusMoveUp = function (e) { return _this.handleFocusMove(e, Direction.UP); };
        this.handleFocusMoveUpInternal = function (e) { return _this.handleFocusMoveInternal(e, Direction.UP); };
        this.handleFocusMoveDown = function (e) { return _this.handleFocusMove(e, Direction.DOWN); };
        this.handleFocusMoveDownInternal = function (e) { return _this.handleFocusMoveInternal(e, Direction.DOWN); };
        ...
        this.handleFocusMove = function (e, direction) {
            ...
            var newSelectionRegions = [Regions.getRegionFromFocusedRegion(newFocusedRegion)];
        ...
        this.handleFocusMoveInternal = function (e, direction) {
            var _a = _this.state, focusedRegion = _a.focusedRegion, selectedRegions = _a.selectedRegions;
            if ((focusedRegion === null || focusedRegion === void 0 ? void 0 : focusedRegion.type) !== FocusMode.CELL) {
                // Move focus with in a selection is only supported for cell focus
                return;
            }
            var newFocusedCell = __assign({}, focusedRegion);
            ...
            if (focusedRegion.focusSelectionIndex == null && selectedRegions.length > 0) {
                ...
                var focusCellRegion = Regions.getCellRegionFromRegion(selectedRegions[focusedRegion.focusSelectionIndex], _this.grid.numRows, _this.grid.numCols);
        ...
        this.handleCopy = function (e) {
            var _a;
            var _b = _this.props, getCellClipboardData = _b.getCellClipboardData, onCopy = _b.onCopy;
            var selectedRegions = _this.state.selectedRegions;
            if (getCellClipboardData == null || _this.grid === undefined || ((_a = window.getSelection()) === null || _a === void 0 ? void 0 : _a.toString())) {
                return;
            }
            ...
            var sparse = Regions.sparseMapCells(cells, function (row, col) {
    ...
    TableHotkeys.moveFocusedRowInDirection = function (focusedRow, direction) {
        switch (direction) {
            case Direction.UP:
                return __assign(__assign({}, focusedRow), { focusSelectionIndex: 0, row: focusedRow.row - 1 });
            case Direction.DOWN:
                return __assign(__assign({}, focusedRow), { focusSelectionIndex: 0, row: focusedRow.row + 1 });
            case Direction.LEFT:
            case Direction.RIGHT:
                return __assign({}, focusedRow);
        }
    };
    TableHotkeys.moveFocusedCellInDirection = function (focusedCell, direction) {
        switch (direction) {
            case Direction.UP:
                return __assign(__assign({}, focusedCell), { focusSelectionIndex: 0, row: focusedCell.row - 1 });
            case Direction.DOWN:
                return __assign(__assign({}, focusedCell), { focusSelectionIndex: 0, row: focusedCell.row + 1 });
            case Direction.LEFT:
                return __assign(__assign({}, focusedCell), { col: focusedCell.col - 1, focusSelectionIndex: 0 });
            case Direction.RIGHT:
                return __assign(__assign({}, focusedCell), { col: focusedCell.col + 1, focusSelectionIndex: 0 });
        }
    };
