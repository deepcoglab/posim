...
var HeaderCell = /** @class */ (function (_super) {
    ...
    HeaderCell.prototype.render = function () {
        ...
        return (React.createElement(ContextMenu, { className: classes, content: (_c = (_b = this.props).menuRenderer) === null || _c === void 0 ? void 0 : _c.call(_b, this.props.index), disabled: !hasMenu, style: this.props.style, ref: this.props.targetRef }, this.props.children));
    };
    return HeaderCell;
}(React.Component));
export { HeaderCell };
