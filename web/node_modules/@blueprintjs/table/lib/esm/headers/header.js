        ...
        return !this.isReorderHandleEnabled()
            ...
            : this.wrapInDragReorderable(index, React.createElement("div", { className: Classes.TABLE_REORDER_HANDLE_TARGET, ref: handleTargetRef },
                React.createElement("div", { className: classNames(Classes.TABLE_REORDER_HANDLE, CLASSNAME_EXCLUDED_FROM_TEXT_MEASUREMENT) },
                    React.createElement(DragHandleVertical, { title: "Press down to drag" }))), false, handleTargetRef);
    };
