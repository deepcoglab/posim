...
var DragSelectable = /** @class */ (function (_super) {
    ...
    function DragSelectable() {
        ...
        _this.invokeOnFocusCallbackForRegion = function (focusRegion, focusSelectionIndex) {
            ...
            onFocusedCell === null || onFocusedCell === void 0 ? void 0 : onFocusedCell(_this.focusedCellUtils.toFocusedRegion(FocusMode.CELL, focusedCellCoords, focusSelectionIndex));
        };
        // Other
        // =====
    ...
    Object.defineProperty(DragSelectable.prototype, "focusedCellUtils", {
        get: function () {
            return __assign(__assign({}, DefaultFocusedCellUtils), this.props.focusedCellUtils);
        },
        enumerable: false,
        configurable: true
    });
    DragSelectable.prototype.render = function () {
        ...
        return (React.createElement(Draggable, __assign({}, draggableProps, { preventDefault: false, targetRef: this.props.targetRef }), this.props.children));
    };
    ...
    DragSelectable.prototype.getFocusedRegion = function () {
        ...
        if (focusedCell != null) {
            return __assign(__assign({}, focusedCell), { type: FocusMode.CELL });
        }
        return undefined;
    };
    ...
    DragSelectable.displayName = "".concat(DISPLAYNAME_PREFIX, ".DragSelectable");
