...
var TableBody2 = /** @class */ (function (_super) {
    ...
    function TableBody2() {
        ...
        _this.renderContextMenu = function (_a) {
            ...
            var menuContext = new MenuContextImpl(targetRegion, nextSelectedRegions, numRows, numCols);
        ...
        _this.handleContextMenu = function (e) {
            var _a = _this.props, focusMode = _a.focusMode, onFocusedRegion = _a.onFocusedRegion, onSelection = _a.onSelection, _b = _a.selectedRegions, selectedRegions = _b === void 0 ? [] : _b;
            ...
            if (foundIndex < 0) {
                ...
                var focusedCellCoords = Regions.getFocusCellCoordinatesFromRegion(targetRegion);
                var newFocusedRegion = toFocusedRegion(focusMode, focusedCellCoords);
    ...
    TableBody2.prototype.render = function () {
        ...
        return (React.createElement(DragSelectable, { enableMultipleSelection: this.props.enableMultipleSelection, focusedRegion: this.props.focusedRegion, focusMode: this.props.focusMode, locateClick: this.locateClick, locateDrag: this.locateDrag, onFocusedRegion: this.props.onFocusedRegion, onSelection: this.props.onSelection, onSelectionEnd: this.handleSelectionEnd, selectedRegions: this.props.selectedRegions, selectedRegionTransform: this.props.selectedRegionTransform, targetRef: this.containerRef },
            React.createElement(ContextMenu, { className: classNames(Classes.TABLE_BODY_VIRTUAL_CLIENT, Classes.TABLE_CELL_CLIENT), content: this.renderContextMenu, disabled: this.props.bodyContextMenuRenderer === undefined, onContextMenu: this.handleContextMenu, ref: this.containerRef, style: style },
                React.createElement(TableBodyCells, { cellRenderer: this.props.cellRenderer, focusedRegion: this.props.focusedRegion, grid: grid, loading: this.props.loading, onCompleteRender: this.props.onCompleteRender, renderMode: this.props.renderMode, columnIndexStart: this.props.columnIndexStart, columnIndexEnd: this.props.columnIndexEnd, rowIndexStart: this.props.rowIndexStart, rowIndexEnd: this.props.rowIndexEnd, viewportRect: this.props.viewportRect }))));
    };
