...
exports.DatePicker3Caption = void 0;
 ...
 */
var DatePicker3Caption = function (props) {
    var _a = (0, react_day_picker_1.useDayPicker)(), rdpClassNames = _a.classNames, formatters = _a.formatters, fromDate = _a.fromDate, toDate = _a.toDate, labels = _a.labels;
    var _b = React.useContext(datePicker3Context_1.DatePicker3Context), locale = _b.locale, reverseMonthAndYearMenus = _b.reverseMonthAndYearMenus;
    ...
    var _c = (0, react_day_picker_1.useNavigation)(), currentMonth = _c.currentMonth, goToMonth = _c.goToMonth, nextMonth = _c.nextMonth, previousMonth = _c.previousMonth;
    ...
    var prevButton = (React.createElement(core_1.Button, { "aria-label": labels.labelPrevious(previousMonth, { locale: locale }), className: (0, classnames_1.default)(classes_1.DatePicker3CaptionClasses.DATEPICKER3_NAV_BUTTON, classes_1.DatePicker3CaptionClasses.DATEPICKER3_NAV_BUTTON_PREVIOUS), disabled: !previousMonth, icon: React.createElement(icons_1.ChevronLeft, null), onClick: handlePreviousClick, variant: "minimal" }));
    var nextButton = (React.createElement(core_1.Button, { "aria-label": labels.labelNext(nextMonth, { locale: locale }), className: (0, classnames_1.default)(classes_1.DatePicker3CaptionClasses.DATEPICKER3_NAV_BUTTON, classes_1.DatePicker3CaptionClasses.DATEPICKER3_NAV_BUTTON_NEXT), disabled: !nextMonth, icon: React.createElement(icons_1.ChevronRight, null), onClick: handleNextClick, variant: "minimal" }));
    ...
    var handleMonthSelectChange = React.useCallback(function (e) {
        ...
        var newDate = datetime_1.DateUtils.clone(currentMonth);
    ...
    var allMonths = React.useMemo(function () {
        var months = [];
        for (var i = datetime_1.Months.JANUARY; i <= datetime_1.Months.DECEMBER; i++) {
    ...
    var monthSelectRightOffset = (0, useMonthSelectRightOffset_1.useMonthSelectRightOffset)(monthSelectElement, containerElement, displayedMonthText);
    var monthSelect = (React.createElement(core_1.HTMLSelect, { "aria-label": labels.labelMonthDropdown(), iconProps: { style: { right: monthSelectRightOffset } }, className: (0, classnames_1.default)(classes_1.DatePicker3CaptionClasses.DATEPICKER3_DROPDOWN_MONTH, rdpClassNames.dropdown_month), key: "month", minimal: true, onChange: handleMonthSelectChange, ref: monthSelectElement, value: displayMonth, options: availableMonthOptions }));
    ...
    var yearSelect = (React.createElement(core_1.HTMLSelect, { "aria-label": labels.labelYearDropdown(), className: (0, classnames_1.default)(classes_1.DatePicker3CaptionClasses.DATEPICKER3_DROPDOWN_YEAR, rdpClassNames.dropdown_year), key: "year", minimal: true, onChange: handleYearSelectChange, value: displayYear, options: allYearOptions }));
    var orderedSelects = reverseMonthAndYearMenus ? [yearSelect, monthSelect] : [monthSelect, yearSelect];
    var hiddenCaptionLabel = (React.createElement("div", { className: classes_1.ReactDayPickerClasses.RDP_VHIDDEN },
        React.createElement(react_day_picker_1.CaptionLabel, { displayMonth: props.displayMonth, id: props.id })));
    return (React.createElement("div", { className: (0, classnames_1.default)(classes_1.DatePicker3CaptionClasses.DATEPICKER3_CAPTION, rdpClassNames.caption), ref: containerElement },
        hiddenCaptionLabel,
        prevButton,
        orderedSelects,
        nextButton));
};
exports.DatePicker3Caption = DatePicker3Caption;
exports.DatePicker3Caption.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".DatePicker3Caption");
