...
exports.DateInput3 = exports.DATEINPUT3_DEFAULT_PROPS = void 0;
...
exports.DATEINPUT3_DEFAULT_PROPS = {
 ...
 */
exports.DateInput3 = React.memo(function DateInput3(props) {
    ...
    var maybeTimezonePicker = React.useMemo(function () {
        return isTimezoneSelectHidden ? undefined : (React.createElement(datetime_1.TimezoneSelect, { buttonProps: timezoneSelectButtonProps, className: classes_1.Classes.DATE_INPUT_TIMEZONE_SELECT, date: tzSelectDate, disabled: isTimezoneSelectDisabled, onChange: handleTimezoneChange, value: timezoneValue },
            React.createElement(core_1.Tag, { endIcon: isTimezoneSelectDisabled ? undefined : "caret-down", interactive: !isTimezoneSelectDisabled, minimal: true }, datetime_1.TimezoneNameUtils.getTimezoneShortName(timezoneValue, tzSelectDate))));
...
exports.DateInput3.defaultProps = exports.DATEINPUT3_DEFAULT_PROPS;
...
function getKeyboardFocusableElements(popoverContentRef) {
    ...
    var elements = core_1.Utils.getFocusableElements(popoverContentRef.current);
