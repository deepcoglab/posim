...
exports.DateRangePicker3 = void 0;
...
var dayPickerModifiers_1 = require("../../common/dayPickerModifiers");
var datePicker3Context_1 = require("../date-picker3/datePicker3Context");
var dateFnsLocalizedComponent_1 = require("../dateFnsLocalizedComponent");
var contiguousDayRangePicker_1 = require("./contiguousDayRangePicker");
var nonContiguousDayRangePicker_1 = require("./nonContiguousDayRangePicker");
...
var DateRangePicker3 = /** @class */ (function (_super) {
    tslib_1.__extends(DateRangePicker3, _super);
    function DateRangePicker3(props) {
        var _a, _b;
        var _this = _super.call(this, props) || this;
        // these will get merged with the user's own
        _this.modifiers = (_a = {},
            _a[dayPickerModifiers_1.HOVERED_RANGE_MODIFIER] = function (day) {
                ...
                return datetime_1.DateUtils.isDayInRange(day, hoverValue, true);
            },
            _a["".concat(dayPickerModifiers_1.HOVERED_RANGE_MODIFIER, "-start")] = function (day) {
                var hoverValue = _this.state.hoverValue;
                if (hoverValue == null || hoverValue[0] == null) {
                    return false;
                }
                return datetime_1.DateUtils.isSameDay(hoverValue[0], day);
            },
            _a["".concat(dayPickerModifiers_1.HOVERED_RANGE_MODIFIER, "-end")] = function (day) {
                var hoverValue = _this.state.hoverValue;
                if (hoverValue == null || hoverValue[1] == null) {
                    return false;
                }
                return datetime_1.DateUtils.isSameDay(hoverValue[1], day);
            },
            _a);
        _this.modifiersClassNames = (_b = {},
            _b[dayPickerModifiers_1.HOVERED_RANGE_MODIFIER] = classes_1.Classes.DATERANGEPICKER3_HOVERED_RANGE,
            _b["".concat(dayPickerModifiers_1.HOVERED_RANGE_MODIFIER, "-start")] = classes_1.Classes.DATERANGEPICKER3_HOVERED_RANGE_START,
            _b["".concat(dayPickerModifiers_1.HOVERED_RANGE_MODIFIER, "-end")] = classes_1.Classes.DATERANGEPICKER3_HOVERED_RANGE_END,
            _b);
        _this.initialMonthAndYear = datetime_1.MonthAndYear.fromDate(new Date());
        _this.handleTimeChange = function (newTime, dateIndex) {
            ...
            var newValue = datetime_1.DateUtils.getDateTime(value[dateIndex] != null ? datetime_1.DateUtils.clone(value[dateIndex]) : _this.getDefaultDate(dateIndex), newTime);
            ...
            _this.setState({ time: newTimeRange, value: newDateRange });
        };
         ...
         */
        _this.formatWeekdayName = function (date) { return (0, date_fns_1.format)(date, "EEEEEE", { locale: _this.state.locale }); };
        _this.handleDayMouseEnter = function (day, activeModifiers, e) {
            ...
            var _e = datetime_1.DateRangeSelectionStrategy.getNextState(_this.state.value, day, _this.props.allowSingleDayRange, _this.props.boundaryToModify), dateRange = _e.dateRange, boundary = _e.boundary;
        ...
        _this.updateSelectedRange = function (selectedRange, selectedTimeRange) {
            ...
            selectedRange[0] = datetime_1.DateUtils.getDateTime(selectedRange[0], selectedTimeRange[0]);
            selectedRange[1] = datetime_1.DateUtils.getDateTime(selectedRange[1], selectedTimeRange[1]);
        ...
        var time = value;
        _this.initialMonthAndYear = datetime_1.MonthAndYear.fromDate(getInitialMonth(props, value));
        _this.state = {
    ...
    DateRangePicker3.prototype.render = function () {
        ...
        var classes = (0, classnames_1.default)(classes_1.Classes.DATEPICKER, classes_1.Classes.DATERANGEPICKER, className, (_a = {},
            _a[classes_1.Classes.DATEPICKER3_HIGHLIGHT_CURRENT_DAY] = this.props.highlightCurrentDay,
            _a[classes_1.Classes.DATERANGEPICKER_CONTIGUOUS] = contiguousCalendarMonths,
            _a[classes_1.Classes.DATERANGEPICKER_SINGLE_MONTH] = isSingleMonthOnly,
            _a[classes_1.Classes.DATERANGEPICKER3_REVERSE_MONTH_AND_YEAR] = this.props.reverseMonthAndYearMenus,
            _a));
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                ...
                if (prevProps.contiguousCalendarMonths !== this.props.contiguousCalendarMonths) {
                    this.initialMonthAndYear = datetime_1.MonthAndYear.fromDate(getInitialMonth(this.props, getInitialValue(this.props)));
                }
                if (isControlled &&
                    (!datetime_1.DateUtils.areRangesEqual(prevProps.value, this.props.value) ||
    ...
    DateRangePicker3.prototype.validateProps = function (props) {
        ...
        if (defaultValue != null && !datetime_1.DateUtils.isDayRangeInRange(defaultValue, dateRange)) {
            console.error(datetime_1.Errors.DATERANGEPICKER_DEFAULT_VALUE_INVALID);
        }
        if (initialMonth != null && !datetime_1.DateUtils.isMonthInRange(initialMonth, dateRange)) {
            console.error(datetime_1.Errors.DATERANGEPICKER_INITIAL_MONTH_INVALID);
        }
        if (maxDate != null && minDate != null && maxDate < minDate && !datetime_1.DateUtils.isSameDay(maxDate, minDate)) {
            console.error(datetime_1.Errors.DATERANGEPICKER_MAX_DATE_INVALID);
        }
        if (value != null && !datetime_1.DateUtils.isDayRangeInRange(value, dateRange)) {
            console.error(datetime_1.Errors.DATERANGEPICKER_VALUE_INVALID);
        }
        if (boundaryToModify != null && boundaryToModify !== core_1.Boundary.START && boundaryToModify !== core_1.Boundary.END) {
            console.error(datetime_1.Errors.DATERANGEPICKER_PREFERRED_BOUNDARY_TO_MODIFY_INVALID);
        }
    };
    DateRangePicker3.prototype.maybeRenderShortcuts = function () {
        ...
        return [
            React.createElement(datetime_1.DatePickerShortcutMenu, { key: "shortcuts", allowSingleDayRange: allowSingleDayRange, maxDate: maxDate, minDate: minDate, selectedShortcutIndex: selectedShortcutIndex, shortcuts: shortcuts, timePrecision: timePrecision, onShortcutClick: this.handleShortcutClick }),
    ...
    DateRangePicker3.prototype.maybeRenderTimePickers = function (isShowingOneMonth) {
        ...
        var isLongTimePicker = (timePickerProps === null || timePickerProps === void 0 ? void 0 : timePickerProps.useAmPm) ||
            timePrecision === datetime_1.TimePrecision.SECOND ||
            timePrecision === datetime_1.TimePrecision.MILLISECOND;
        return (React.createElement("div", { className: (0, classnames_1.default)(classes_1.Classes.DATERANGEPICKER_TIMEPICKERS, (_a = {},
                _a[classes_1.Classes.DATERANGEPICKER3_TIMEPICKERS_STACKED] = isShowingOneMonth && isLongTimePicker,
                _a)) },
            React.createElement(datetime_1.TimePicker, tslib_1.__assign({ precision: timePrecision }, timePickerProps, { onChange: this.handleTimeChangeLeftCalendar, value: this.state.time[0] })),
            React.createElement(datetime_1.TimePicker, tslib_1.__assign({ precision: timePrecision }, timePickerProps, { onChange: this.handleTimeChangeRightCalendar, value: this.state.time[1] }))));
    };
    /**
    ...
    DateRangePicker3.prototype.renderContiguousDayRangePicker = function (singleMonthOnly) {
        var _a = this.props, dayPickerProps = _a.dayPickerProps, props = tslib_1.__rest(_a, ["dayPickerProps"]);
        return (React.createElement(contiguousDayRangePicker_1.ContiguousDayRangePicker, tslib_1.__assign({}, props, { contiguousCalendarMonths: true, dayPickerEventHandlers: {
    ...
    DateRangePicker3.prototype.renderNonContiguousDayRangePicker = function () {
        var _a = this.props, dayPickerProps = _a.dayPickerProps, props = tslib_1.__rest(_a, ["dayPickerProps"]);
        return (React.createElement(nonContiguousDayRangePicker_1.NonContiguousDayRangePicker, tslib_1.__assign({}, props, { dayPickerProps: this.resolvedDayPickerProps, dayPickerEventHandlers: {
                onDayMouseEnter: this.handleDayMouseEnter,
                onDayMouseLeave: this.handleDayMouseLeave,
    ...
    Object.defineProperty(DateRangePicker3.prototype, "resolvedDayPickerProps", {
        get: function () {
            ...
            return tslib_1.__assign(tslib_1.__assign({}, dayPickerProps), { classNames: tslib_1.__assign(tslib_1.__assign({}, classes_1.dayPickerClassNameOverrides), dayPickerProps.classNames), formatters: tslib_1.__assign({ formatWeekdayName: this.formatWeekdayName }, dayPickerProps.formatters), modifiers: (0, dayPickerModifiers_1.combineModifiers)(this.modifiers, dayPickerProps.modifiers), modifiersClassNames: tslib_1.__assign(tslib_1.__assign({}, this.modifiersClassNames), dayPickerProps.modifiersClassNames) });
        },
        enumerable: false,
        configurable: true
    });
    ...
    DateRangePicker3.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".DateRangePicker3");
    return DateRangePicker3;
}(dateFnsLocalizedComponent_1.DateFnsLocalizedComponent));
exports.DateRangePicker3 = DateRangePicker3;
function getIsSingleMonthOnly(props) {
    return props.singleMonthOnly || datetime_1.DateUtils.isSameMonth(props.minDate, props.maxDate);
}
...
function getInitialMonth(props, value) {
    ...
    if (props.initialMonth != null) {
        if (!isSingleMonthOnly && datetime_1.DateUtils.isSameMonth(props.initialMonth, props.maxDate)) {
            // special case: if initial month is same as maxDate month, display it on the right calendar
            return datetime_1.DateUtils.getDatePreviousMonth(props.initialMonth);
        }
        return props.initialMonth;
    }
    else if (value[0] != null) {
        if (!isSingleMonthOnly && datetime_1.DateUtils.isSameMonth(value[0], props.maxDate)) {
            // special case: if start of range is selected and that date is in the maxDate month, display it on the right calendar
            return datetime_1.DateUtils.getDatePreviousMonth(value[0]);
        }
        return datetime_1.DateUtils.clone(value[0]);
    }
    else if (value[1] != null) {
        var month = datetime_1.DateUtils.clone(value[1]);
        if (!datetime_1.DateUtils.isSameMonth(month, props.minDate)) {
            month.setMonth(month.getMonth() - 1);
        }
        return month;
    }
    else if (datetime_1.DateUtils.isDayInRange(today, [props.minDate, props.maxDate])) {
        if (!isSingleMonthOnly && datetime_1.DateUtils.isSameMonth(today, props.maxDate)) {
        ...
        var betweenDate = datetime_1.DateUtils.getDateBetween([props.minDate, props.maxDate]);
        if (!isSingleMonthOnly && datetime_1.DateUtils.isSameMonth(betweenDate, props.maxDate)) {
