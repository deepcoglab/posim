...
var DateRangeInput3 = /** @class */ (function (_super) {
    ...
    function DateRangeInput3(props) {
        ...
        _this.handleInputArrowKeyDown = function (e, boundary) {
            ...
            var inputElement = boundary === Boundary.START ? _this.startInputElement : _this.endInputElement;
            ...
            e.preventDefault();
            var clampedDate = clampDate(shiftedDate, minDate, maxDate);
        ...
        _this.getIsOpenValueWhenDateChanges = function (nextSelectedStart, nextSelectedEnd) {
            if (_this.props.closeOnSelection) {
                ...
                var fallbackDate = getTodayAtMidnight();
    ...
    DateRangeInput3.prototype.getNextDateForArrowKeyNavigation = function (arrowKey, boundary) {
        ...
        var initialDate = boundary === Boundary.START ? selectedStart : selectedEnd;
        if (initialDate == null) {
            return undefined;
        }
        var relativeDate = shiftDateByArrowKey(initialDate, arrowKey);
        // Ensure that we don't move onto a single day range selection if that is disallowed
        var adjustedStart = selectedStart == null || allowSingleDayRange ? selectedStart : shiftDateByDays(selectedStart, 1);
        var adjustedEnd = selectedEnd == null || allowSingleDayRange ? selectedEnd : shiftDateByDays(selectedEnd, -1);
    ...
    DateRangeInput3.prototype.getDefaultDateForArrowKeyNavigation = function (arrowKey, boundary) {
        var _a = this.getSelectedRange(), selectedStart = _a[0], selectedEnd = _a[1];
        var otherBoundary = boundary === Boundary.START ? selectedEnd : selectedStart;
