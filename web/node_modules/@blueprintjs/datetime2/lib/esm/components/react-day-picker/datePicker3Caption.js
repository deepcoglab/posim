...
export var DatePicker3Caption = function (props) {
    ...
    var prevButton = (React.createElement(Button, { "aria-label": labels.labelPrevious(previousMonth, { locale: locale }), className: classNames(CaptionClasses.DATEPICKER3_NAV_BUTTON, CaptionClasses.DATEPICKER3_NAV_BUTTON_PREVIOUS), disabled: !previousMonth, icon: React.createElement(ChevronLeft, null), onClick: handlePreviousClick, variant: "minimal" }));
    var nextButton = (React.createElement(Button, { "aria-label": labels.labelNext(nextMonth, { locale: locale }), className: classNames(CaptionClasses.DATEPICKER3_NAV_BUTTON, CaptionClasses.DATEPICKER3_NAV_BUTTON_NEXT), disabled: !nextMonth, icon: React.createElement(ChevronRight, null), onClick: handleNextClick, variant: "minimal" }));
