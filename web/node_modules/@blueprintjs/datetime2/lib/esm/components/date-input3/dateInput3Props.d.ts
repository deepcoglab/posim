 ...
 */
type DateInputSharedProps = Omit<DateInputProps, "dayPickerProps" | "formatDate" | "locale" | "localeUtils" | "modifiers" | "parseDate">;
export interface DateInput3Props extends DateInputSharedProps, ReactDayPickerSingleProps, DateFnsLocaleProps, Partial<Omit<DateFormatProps, "locale">> {
    /**
...
export type DateInput3DefaultProps = Required<Pick<DateInput3Props, "closeOnSelection" | "disabled" | "invalidDateMessage" | "locale" | "maxDate" | "minDate" | "outOfRangeMessage" | "reverseMonthAndYearMenus">>;
