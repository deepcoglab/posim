 ...
 */
export function DatePicker3Dropdown({ caption, children, ...props }) {
    ...
    const iconProps = React.useMemo(() => (props.name === "months" ? { style: { right: monthSelectRightOffset } } : {}), [props.name, monthSelectRightOffset]);
    return (React.createElement("div", { ref: containerElement },
        React.createElement(HTMLSelect, { iconProps: iconProps, minimal: true, ref: selectElement, ...props }, children)));
}
