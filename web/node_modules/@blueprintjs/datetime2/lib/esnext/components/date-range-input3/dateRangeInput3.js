 ...
 */
export class DateRangeInput3 extends DateFnsLocalizedComponent {
    static defaultProps = {
    ...
    static displayName = `${DISPLAYNAME_PREFIX}.DateRangeInput3`;
