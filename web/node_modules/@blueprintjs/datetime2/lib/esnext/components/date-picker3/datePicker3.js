...
import { DatePickerShortcutMenu, DatePickerUtils, DateUtils, Errors, TimePicker, TimezoneUtils, } from "@blueprintjs/datetime";
 ...
 */
export class DatePicker3 extends DateFnsLocalizedComponent {
    static defaultProps = {
    ...
    static displayName = `${DISPLAYNAME_PREFIX}.DatePicker3`;
            ...
            React.createElement("div", { className: Classes.DATEPICKER_CONTENT },
                React.createElement(DatePicker3Provider, { ...this.props, ...this.state },
                    React.createElement(DayPicker, { locale: locale, showOutsideDays: true, ...dayPickerProps, captionLayout: "dropdown-buttons", classNames: {
                        ...
                        }, fromDate: minDate, mode: "single", month: new Date(displayYear, displayMonth), onMonthChange: this.handleMonthChange, onSelect: this.handleDaySelect, required: !this.props.canClearSelection, selected: this.state.value ?? undefined, toDate: maxDate }),
    ...
    renderOptionsBar() {
        ...
        return [
            ...
            React.createElement("div", { className: Classes.DATEPICKER_FOOTER, key: "footer" },
                React.createElement(Button, { disabled: !todayEnabled, onClick: this.handleTodayClick, text: todayButtonText, variant: "minimal" }),
                React.createElement(Button, { disabled: !canClearSelection, onClick: this.handleClearClick, text: clearButtonText, variant: "minimal" })),
        ];
    }
    ...
    maybeRenderShortcuts() {
        ...
        return [
            React.createElement(DatePickerShortcutMenu, { key: "shortcuts", allowSingleDayRange: true,
                maxDate,
                minDate,
                selectedShortcutIndex,
                shortcuts: dateRangeShortcuts,
                timePrecision, onShortcutClick: this.handleShortcutClick, useSingleDateShortcuts: true }),
            React.createElement(Divider, { key: "div" }),
        ];
    }
