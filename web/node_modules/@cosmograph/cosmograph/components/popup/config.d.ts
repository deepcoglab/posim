export interface CosmographPopupConfig {
     ...
     * @default undefined
     */
    bindTo?: string | number | [number, number];
    /**
     * Placement of the popup relative to the bound point: 'top' or 'bottom'.
     * @default 'top'
     */
...
export declare const defaultCosmographPopupConfig: CosmographPopupConfig;
