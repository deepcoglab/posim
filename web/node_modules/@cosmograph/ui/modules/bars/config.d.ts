...
export declare const defaultMaxDisplayedItems = 10;
export type BarsConfigInterface = DisplayStateConfigInterface & {
    /**
     * The maximum number of bars to display in the bars visualization.
     * When exceeded, a "show more" button will appear to display additional items.
     * @default 10
     */
    maxDisplayedItems?: number;
    /**
     * Specifies whether the sorting block should be visible.
     * The sorting block allows users to sort bars by count or alphabetically.
     * @default true
     */
    ...
    /**
     * Moves filtered bars to the top while filtering is active.
     * If `false`, filtering does not reorder bars.
     * @default false
     */
    moveFilteredToTop?: boolean;
    /**
     * Enables smooth transition when bars re-order (sort/search/filter updates).
     * Automatically disabled when the user has `prefers-reduced-motion: reduce`.
     * @default true
     */
    animateSort?: boolean;
    /**
     * Sort animation duration in milliseconds.
     * @default 250
     */
    sortAnimationDurationMs?: number;
    /**
     * Specifies whether the total count should be displayed alongside the filtered count when filtering is active.
     * If set to `true`, the count will be displayed as "filtered / total" (e.g., "5 / 10").
     * If set to `false`, only the filtered count will be displayed.
     * @default false
     */
    ...
    /**
     * A formatter function that is used to format the count values displayed on the bars.
     * This allows for custom formatting of numbers (e.g., adding thousand separators, currency symbols, etc.).
     ...
     * @param data - The data for the clicked bar, or undefined if no bar is selected
     * @param event - Native mouse event for click metadata (e.g. `shiftKey`)
     */
    onClick?: (data?: BarData, event?: MouseEvent) => void;
    /**
...
export declare const defaultBarsConfig: BarsConfigInterface;
